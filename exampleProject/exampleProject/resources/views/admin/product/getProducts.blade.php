                ...
                <tbody>
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td class="text-center" width="100px"> 
                                <a href="updateProduct/{{$product->pid}}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                <a href="deleteProduct/{{$product->pid}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
